const Footer = () => {
    return (
        <footer className="px-6 divide-y bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    ...
                    <p className="mt-6 mb-8 pr-7 sm:mb-12">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase text-gray-900  dark:text-gray-100">
                            Services
                        </h3>
                        <ul className="space-y-1">
                            <li>
                                <a to="/createnote">Create Note</a>
                            </li>
                            <li>
                                <a to="/notes">See Notes</a>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <a to="/tandc">Terms of Service</a>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
                        <h3 className="uppercase text-gray-900  dark:text-gray-100">Account</h3>
                        <ul className="space-y-1">
                            <li>
                                <a to="/login">Sign-in</a>
                            </li>
                            <li>
                                <a to="/signup">Free Join</a>
                            </li>
                            <li>
                        ...
                        <div className="flex justify-start space-x-3">
                            ...
                            >
                                <svg
                                    ...
                                    fill="currentColor"
                                    viewBox="0 0 32 32"
                                    className="w-5 text-rose-500 h-5 fill-current"
                                >
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">
                © 2000 mynotebook. All rights reserved.
            </div>
        </footer>
    );
};
